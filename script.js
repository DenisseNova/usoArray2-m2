...
document.write("<p>=========================================================================</p>");
document.write("<h2>HORAS DENTAL</h2>");
...
document.write("<h2>PACIENTES DEL CENTRO MÉDICO</h2>");
const nombrePaciente = radiologia.concat(traumatologia, dental);
nombrePaciente.forEach(function (elemento) {
  document.write(`<p>${elemento.paciente}</p>`);
});
document.write("<p>=========================================================================</p>");

const isapres = dental.filter(function (elemento) {
  return elemento.prevision == "ISAPRE";
});
document.write("<h2>PACIENTES DENTAL ISAPRE</h2>");
isapres.forEach(function (elemento) {
  document.write(`<p>${elemento.paciente}-${elemento.prevision}</p>`);
});
document.write("<p>=========================================================================</p>");

const fonasa = traumatologia.filter(function (elemento) {
  return elemento.prevision == "FONASA";
});
document.write("<h2>PACIENTES TRAUMATOLOGÍA FONASA</h2>");
fonasa.forEach(function (elemento) {
  document.write(`<p>${elemento.paciente}-${elemento.prevision}</p>`);
});
document.write("<p>=========================================================================</p>");
